 ...
 */
export class FormBuildModel extends Base
  implements
    ISurvey,
    ISurveyData,
    ISurveyImpl,
  ...
  public get platformName(): string {
    return FormBuildModel.platform;
  }
  /**
  ...
  public onComplete: Event<
    (sender: FormBuildModel, options: any) => any,
    any
  > = new Event<(sender: FormBuildModel, options: any) => any, any>();
  /**
   ...
   */
  public onStarted: Event<(sender: FormBuildModel) => any, any> = new Event<
    (sender: FormBuildModel) => any,
    any
  >();
  /**
   ...
   */
  public onPartialSend: Event<(sender: FormBuildModel) => any, any> = new Event<
    (sender: FormBuildModel) => any,
    any
  >();
  /**
   ...
   * @see onValidatePanel
   */
  public onServerValidateQuestions: (sender: FormBuildModel, options: any) => any;
  /**
...
> = new Event<(sender: FormBuildModel, options: any) => any, any>();
   ...
   * @see Page.timeSpent
   */
  public onTimer: Event<(sender: FormBuildModel) => any, any> = new Event<
    (sender: FormBuildModel) => any,
    any
  >();
  /**
